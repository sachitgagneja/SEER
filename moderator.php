...
<div class="container text-center my-auto">
    ...
    if (mysqli_query($connection, 'DESCRIBE moderation')) {
    ...
    <div class="card text-center">
        <div class="card-header">
            ...
            if(mysqli_num_rows($result) > 1){
                echo mysqli_num_rows($result) . ' Submissions are pending for Moderation';
            }
            elseif (mysqli_num_rows($result) == 1){
                echo mysqli_num_rows($result) . ' Submission is pending for Moderation';
            }
            ?>
        </div>
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                ...
                echo '<br>Author: ' . $row['author'].'<br><hr>';
                ?>
